...
public class BioClipseConvenience {
	 ...
	 */
	public BioClipseConvenience(double mzabs, double mzppm, double searchPPM, String peaks, String database, boolean sumFormulaRedundancyCheck, String sumFormula, int limit, int mode, double exactMass)
	{
		this.mzabs = mzabs;
		this.mzppm = mzppm;
...
//		}
		...
		"147.044 6078.145 606\n153.019 10000.0 999\n179.036 141.192 13\n189.058 176.358 16\n" +
		"273.076 10000.000 999\n274.083 318.003 30\n";
		BioClipseConvenience bcc = new BioClipseConvenience(0.01, 50.0, 10.0, peaks, "kegg", true, "", 50, 1, 272.06847);
